  ...
  <div>
    <el-row>
      <el-col style="text-align: left;">
        <el-button @click="showProfilerInfo()" type="primary">刷新数据</el-button>
        <el-button @click="createProfilerInfo()" type="primary">新建采样</el-button>
    ...
    <el-table :data="profilerInfos" :height="dynamicHeight" style="margin-top:10px;" border stripe>
      <el-table-column prop="profilerName" label="profiler名称" width="350"></el-table-column>
      <el-table-column prop="intervalMillis" label="采样/报告间隔" width="350"></el-table-column>
      <el-table-column  label="操作" width="350">
        <template slot-scope="scope">
            <el-button @click="editProfilerInfo(scope.row)" type="text" size="small">修改间隔</el-button>
            <el-button @click="disableProfiler(scope.row)" type="text" size="small" >关闭</el-button>
        </template>

      </el-table-column>
      
    </el-table>
    <el-dialog :title="profiler.profilerName.length > 0 ? '修改采样间隔' : '新建采样'" :visible.sync="editDialogVisible" width="50%">
      <el-form ref="form" :model="profiler" label-width="80px">
          <el-form-item label="采样类型">
            <el-select v-model="profiler.profilerName" placeholder="请选择采样类型" :disabled="editing">
          <el-option
          ...
          <el-form-item label="采样间隔">
            <el-input v-model="profiler.samplingInterval" placeholder="采样间隔(ms,需大于100)" :disabled="profiler.profilerName != 'Stacktrace'" type="number" min="100"></el-input>
          </el-form-item>
      
       
          <el-form-item label="报告间隔">
            <el-input v-model="profiler.reportInterval" placeholder="报告间隔(ms,需大于100)" type="number" min="100"></el-input>
          </el-form-item>
       
      
          <el-button @click="saveProfilerInfo()" type="primary">保存</el-button>
