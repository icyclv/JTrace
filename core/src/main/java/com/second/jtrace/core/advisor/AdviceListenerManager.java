...
public class AdviceListenerManager {
     ...
     */
    public static ConcurrentWeakKeyHashMap<String, List<AbstractEnhanceAdviceListener>> adviceListenerMap = new ConcurrentHashMap<String, List<AbstractEnhanceAdviceListener>>();
    /**
     * 方法内的调用切面集合
     ...
     */
    public static ConcurrentWeakKeyHashMap<String, List<AbstractEnhanceAdviceListener>> invokeListenerMap = new ConcurrentHashMap<String, List<AbstractEnhanceAdviceListener>>();
